...
public class Loading extends javax.swing.JFrame implements Runnable{
    ...
    public void run(){
        try{
            for(int i=1; i<=200; i++){
                s += 1;
                // Get maximum value of progressBar1 and assign to maxVal.
                int maxVal = jProgressBar1.getMaximum();
                // Get value of progressBar1 and assign to val.
                int val = jProgressBar1.getValue();
                if (val < maxVal){
                    // Increment one and Set ProgressBar value. 
                    jProgressBar1.setValue(jProgressBar1.getValue() + 1);
                } else {
                    i = 201;
                    setVisible(false);
                    // Creating new Home object.
                    Home ob = new Home();
                    ob.setVisible(true);    
                }
                Thread.sleep(50);
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("/home/berkaypc/Downloads/loadingBook.gif")); // NOI18N
        ...
        setSize(new java.awt.Dimension(582, 700));
